...
#include "../../data_structure1/registerwidget.h"
...
QT_MOC_LITERAL(1, 15, 10), // "back_login"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "RegisterWidget\0back_login\0"
};
...
void RegisterWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RegisterWidget::back_login)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RegisterWidget::back_login()
{
